...
# Start sermon auto-ingest scheduler (runs on Monday and Thursday at 6 AM PST)
echo "Starting sermon auto-ingest scheduler (Mon/Thu 6 AM PST)..."
(
  LAST_INGEST_DAY=""
  while true; do
...
echo "  Auto-Ingest PID: $INGEST_PID (Mon/Thu 6AM PST)"
